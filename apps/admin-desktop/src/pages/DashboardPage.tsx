import { Container, Title, Text, Paper, Stack, Group, SimpleGrid, Badge, Code, Loader, Alert } from "@mantine/core";
...
export function DashboardPage() {
  ...
  return (
    <Container size="lg">
      ...
      <Text c="dimmed" mb="xl">Starkeep Admin Desktop</Text>
      ...
      <SimpleGrid cols={{ base: 1, md: 2 }}>
        <Paper p="lg" withBorder>
          <Title order={3} size="h4" mb="md">Recent Deployments</Title>
        ...
        <Paper p="lg" withBorder>
          <Title order={3} size="h4" mb="md">Data Store</Title>
          {!dataStats ? (
            ...
            <Text c="dimmed" size="sm">No data records yet</Text>
          ) : (
            <Stack gap="xs">
