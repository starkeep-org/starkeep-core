  ...
  return (
    <Container size="xl">
      <Group justify="space-between" mb="xl">
        ...
        <Button component={Link} to="/deployments/new">
          + New Deployment
        </Button>
      </Group>
            ...
            {plans.map((plan) => {
              ...
              return (
                <Table.Tr key={plan.id}>
                  <Table.Td><Code>{plan.stack_name}</Code></Table.Td>
                  <Table.Td><Code>{plan.region}</Code></Table.Td>
                  <Table.Td>
                    {plan.environment && <Badge>{plan.environment}</Badge>}
                  </Table.Td>
                  <Table.Td>
                    {plan.template_type && <Badge variant="light">{plan.template_type}</Badge>}
                  </Table.Td>
